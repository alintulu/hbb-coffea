...
class AdelinaProcessor(processor.ProcessorABC):
    def __init__(self, year='2017', jet_arbitration='pt', tagger='v2',
        ...
        self.make_output = lambda: {
            ...
            'templates': hist.Hist(
                ...
                hist.Bin('pt1', r'Jet $p_{T}$ [GeV]', 100, 250, 1200),#[400, 450, 500, 550, 600, 675, 800, 1200]),
                ...
                hist.Bin('rho1', r"$\rho = \ln (m_{SD}^2 / p_T^2)$", 100, -6, -0.5),
    ...
    def process_shift(self, events, shift_name):
        ...
        selection.add('ddt', (candidatejet.pt > 250) & (candidatejet.isTight))
